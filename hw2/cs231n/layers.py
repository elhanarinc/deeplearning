        ...
        # Convolve this filter over windows
            ...
            for k in xrange(Hp):
                ...
                for l in xrange(Wp):
                    ...
                    current_field = padded[i, :, hs:hss, ws:wss]
                    out[i, j, k, l] = np.sum(current_field * w[j]) + b[j]
        ...
        # Convolve this filter over windows
            ...
            for k in xrange(Hp):
                ...
                for l in xrange(Wp):
                    ...
                    current_field = x_padded[i, :, hs:hss, ws:wss]
                    current_derivative = dout[i, j, k, l]
        ...
        for j in xrange(C):
            for k in xrange(Hp):
                ...
                for l in xrange(Wp):
                    ...
                    current_field = x[i, j, hs:hss, ws:wss]
                    out[i, j, k, l] = np.max(current_field)
        ...
        for j in xrange(C):
            for k in xrange(Hp):
                ...
                for l in xrange(Wp):
                    ...
                    indices = np.where(current_field == current_field.max())
                    p, q = zip(indices[0], indices[1])[0]
