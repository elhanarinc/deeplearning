...
class CaptioningRNN(object):
  ...
  def loss(self, features, captions):
    ...
    ## Start forward pass ##
    #########################
    # 1 get from layers.py
    # features (N, D)
    # Image to initial hidden
    h0 , cache0 = affine_forward(features, W_proj, b_proj)

    # 2 already implemented from rnn_layers
    # Word embedding
    word_out, cache_embedded = word_embedding_forward(captions_in, W_embed)
    ...
    dx_aff_temp, dw_aff_temp, db_aff_temp = temporal_affine_backward(dout, cache_aff)
    ...
    grads['Wh'] = dWh
    grads['b'] = db
    grads['W_vocab'] = dw_aff_temp
    grads['b_vocab'] = db_aff_temp
